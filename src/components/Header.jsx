    ...
    <header className="header">
      <div className="header-content">
        ...
        <div className="header-center">
          ...
          <svg className="notification-icon" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <path d="M11.4417 17.5C11.2952 17.7526 11.0849 17.9622 10.8319 18.1079C10.5789 18.2537 10.292 18.3304 10 18.3304C9.70803 18.3304 9.42117 18.2537 9.16816 18.1079C8.91514 17.9622 8.70482 17.7526 8.55835 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
